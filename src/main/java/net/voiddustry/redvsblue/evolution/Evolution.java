...
public enum Evolution {
    ...
    MONO(UnitTypes.mono, 1, 60*multp, new String[] { "poly", "nova", "merui", "dagger" }),
    ...
    SCEPTER(UnitTypes.scepter, 7, 105*multp, new String[] { "vanquish", "nuke boy" }),
    ...
    VANQUISH(UnitTypes.vanquish, 8, 250*multp, new String[] { "reign", "nuke boy" }),
