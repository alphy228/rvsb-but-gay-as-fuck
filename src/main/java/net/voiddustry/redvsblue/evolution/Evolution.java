...
public enum Evolution {
    ...
    ELUDE(UnitTypes.elude, 1, 10*multp, new String[] { "atrax", "nova", "flare", "dagger", "mono" }),
    FLARE(UnitTypes.flare, 1, 6*multp, new String[] { "risso", "nova", "elude", "dagger", "mono" }),
    MONO(UnitTypes.mono, 1, 5*multp, new String[] { "poly", "nova", "elude", "dagger" }),

    PULSAR(UnitTypes.pulsar, 2, 25*multp, new String[] { "quasar" }),
    ATRAX(UnitTypes.atrax, 2, 18*multp, new String[] { "cleroi" }),
    RISSO(UnitTypes.risso, 2, 45*multp, new String[] { "zenith" }),
    POLY(UnitTypes.poly, 2, 21*multp, new String[] { "retusa" }),

    MACE(UnitTypes.mace, 3, 20*multp, new String[] { "fortress"}),
    QUASAR(UnitTypes.quasar, 3, 60*multp, new String[] { "vela" }),
    CLEROI(UnitTypes.cleroi, 3, 65*multp, new String[] { "spiroct" }),
    ZENITH(UnitTypes.zenith, 3, 70*multp, new String[] { "minke" }),
    RETUSA(UnitTypes.retusa, 3, 15*multp, new String[] { "oxynoe" }),

    FORTRESS(UnitTypes.fortress, 4, 48*multp, new String[] { "locus" }),
    VELA(UnitTypes.vela, 4, 170*multp, new String[] { "corvus" }),
    ...
    LOCUS(UnitTypes.locus, 5, 55*multp, new String[] { "precept" }),
    ...
    CYERCE(UnitTypes.cyerce, 6, 150*multp, new String[] { "quad" }),
    ...
    QUAD(UnitTypes.quad, 7, 450*multp, new String[] { "oct" }),
